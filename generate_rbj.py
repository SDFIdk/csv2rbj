...
The generated rbj files contain more line breaks than rbj files generated by ArcGIS, but
they don't seem to affect the functionality, so we'll leave them in for now.
